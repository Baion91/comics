# Handoff — cập nhật lần cuối: 2026-09-02 (reader: SW revalidate theo URL + waitUntil + SW_VERSION hash mã SW; trang đọc tự vá ảnh qua /api/pages — trị "repair xong app vẫn ảnh cũ"; comix tráo ô đã E2E)
