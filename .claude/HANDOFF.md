# Handoff — cập nhật lần cuối: 2026-09-12 (provider MỚI ZetTruyen `zettruyen1.com` — API list + ảnh SSR, E2E dev OK; trước đó: comix GHIM NHÓM + tráo ô, reader SW revalidate/waitUntil/syncPages)
...
## Đang làm / dở dang
- **[12/09] Provider MỚI: ZetTruyen (`zettruyen1.com`) — ĐÃ code + NGHIỆM THU E2E ở dev, chờ push + `/update`** (`providers.py`; docs ARCHITECTURE).
